...
/**
 * struct liststr - stream of the linked list
 * @num: a num scope
 * @str: a str scope
 * @next: a posterior node
 */
...
/**
 *struct passinfo - holds false-args to overrun into a function, permitting regular prototype
...
/**
 *struct builtin - holds the formation of a string and function
 *@type: the formation cmd
 *@func: the task
 */
